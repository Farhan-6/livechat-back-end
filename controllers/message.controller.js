...
const { getReceiverSocket } = require("../lib/socket.js");
...
const sendMessage = async (req, res) => {
  try {
    ...
    // Send WS event to sender too
    const senderSocket = getReceiverSocket(senderId.toString());
